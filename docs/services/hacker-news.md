...
- [Rio de Janeiro's "homegrown" LLM appears to be a merge of an existing model](./hacker-news/2026-06-rio-de-janeiro-s-homegrown-llm-appears-to-be-a-merge-of-an-existing-mode-62fad39e.md) `published` / score 65.0
- [Amazon CEO's talks with U.S. officials triggered crackdown on Anthropic models](./hacker-news/2026-06-amazon-ceo-s-talks-with-u-s-officials-triggered-crackdown-on-anthropic-m-3f5abbdd.md) `published` / score 65.0
...
- [Rio de Janeiro's "homegrown" LLM appears to be a merge of an existing model](./hacker-news/2026-06-rio-de-janeiro-s-homegrown-llm-appears-to-be-a-merge-of-an-existing-mode-62fad39e.md) `published`
...
- [TinyWind: A pixel pirate sailing game with real wind physics (380k+ kms sailed)](./hacker-news/2026-06-tinywind-a-pixel-pirate-sailing-game-with-real-wind-physics-380k-kms-sai-915a6058.md) `published`
- [Not everyone is using AI for everything](./hacker-news/2026-06-not-everyone-is-using-ai-for-everything-504097de.md) `published`
- [I indexed 669 GB of my GoPro videos using my M1 Max computer and local ML models](./hacker-news/2026-06-i-indexed-669-gb-of-my-gopro-videos-using-my-m1-max-computer-and-local-m-c06b5019.md) `published`
